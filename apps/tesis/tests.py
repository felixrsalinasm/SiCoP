    ...
    def setUp(self):
        ...
        self.prof1 = Profesor.objects.create(
            persona=Persona.objects.create(
                ...
                rfc='P1000', curp='C1000', email='p1@ejemplo.com'
            ),
            activo=True
        )
        self.prof2 = Profesor.objects.create(
            persona=Persona.objects.create(
                ...
                rfc='P2000', curp='C2000', email='p2@ejemplo.com'
            ),
            activo=True
        )
        self.prof3 = Profesor.objects.create(
            persona=Persona.objects.create(
                ...
                rfc='P3000', curp='C3000', email='p3@ejemplo.com'
            ),
            activo=True
        )

        prog = Programa.objects.create(siglas='MCC', activo=True)
        self.est = Estudiante.objects.create(
            persona=Persona.objects.create(
                usuario=Usuario.objects.create_user(username='e1', password='p', rol=Usuario.Roles.SECRETARIA),
                rfc='E1000', curp='C1000E', email='e1@ejemplo.com'
            ),
            programa=prog,
            matricula='A1',
            generacion='2024-A'
